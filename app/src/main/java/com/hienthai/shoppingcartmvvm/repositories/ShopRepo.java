package com.hienthai.shoppingcartmvvm.repositories;
...
public class ShopRepo {
    ...
    private void loadProducts() {
        ...
        productList.add(new Product(UUID.randomUUID().toString(), "iPad Air", 799, false, "https://firebasestorage.googleapis.com/v0/b/notes-16738.appspot.com/o/products%2Fipadair.jpeg?alt=media&token=da387155-bd8f-4343-954b-e46da7d252ae"));
        ...
        productList.add(new Product(UUID.randomUUID().toString(), "MacBook Air", 999, false, "https://firebasestorage.googleapis.com/v0/b/notes-16738.appspot.com/o/products%2Fmacbookair.jpeg?alt=media&token=aae96a4a-e86a-4a15-825a-3da9851330c8"));
